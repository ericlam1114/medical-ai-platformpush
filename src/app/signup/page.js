          ...
          <form className="mt-8 space-y-6" onSubmit={handleSignUp}>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#0084C7] hover:bg-[#0084C7]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0084C7]"
              >
